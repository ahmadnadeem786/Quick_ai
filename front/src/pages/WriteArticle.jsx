...
const WriteArticle = () => {
  ...
  const onsubmitHandler = async (e) => {
    ...
    try {
      ...
      console.log("Clerk Token:", token); // <- Check this
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start justify-between flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <label className="mt-6 text-sm font-medium block">Article Topic</label>
        <input
        ...
        <label className="mt-4 text-sm font-medium block">Article Length</label>
